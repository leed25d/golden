...
* data from database filled by a OleDbDataAdapter. OleDbDataAdapter serves as a bridge
...
* to database is made using OleDbConnection object. 
*
...
namespace DSPopulate
{
	...
	public class ViewProducts : Form
	{
		...
		* 1. The 'SelectCommand' property of OleDbAdapter facilitates 
        *    loading of data based on the query given, to access 'Products' data.
		* 2. 'OleDbAdapter.Fill' command loads the data from data source to the 
		*    DataSet.
		...
		************************************************************************/
		public void displayProducts()
		{
			try
			{
                ...
                productsAdapter.SelectCommand = new OleDbCommand("SELECT " +
					"Product_ID , " +
					"Product_Name , " +
					"Product_Desc , " +
					"Category, " +
		...
		************************************************************************/
       	...
       	private void InitializeComponent()
		{
			...
			// 
			this.productsDataGridTableStyle.AlternatingBackColor = System.Drawing.SystemColors.Window;
			this.productsDataGridTableStyle.BackColor = System.Drawing.SystemColors.Window;
			...
			this.productsDataGridTableStyle.GridColumnStyles.AddRange(new System.Windows.Forms.DataGridColumnStyle[] {
																														 ...
																														 this.Category,
																														 this.Price});
			this.productsDataGridTableStyle.GridLineColor = System.Drawing.SystemColors.Control;
			this.productsDataGridTableStyle.HeaderBackColor = System.Drawing.SystemColors.Control;

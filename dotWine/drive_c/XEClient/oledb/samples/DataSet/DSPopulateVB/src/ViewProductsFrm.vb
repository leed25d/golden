...
' that contains data from database filled by a OleDbAdapter.
' OleDbAdapter serves as a bridge between the DataSet and the data source, 
...
'
' This sample application is a Visual Baisc .Net application that displays a list
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'productsDataGrid
        '
        Me.productsDataGrid.AlternatingBackColor = System.Drawing.SystemColors.Window
        Me.productsDataGrid.BackgroundColor = System.Drawing.SystemColors.AppWorkspace
        Me.productsDataGrid.CaptionBackColor = System.Drawing.SystemColors.ActiveCaption
        ...
        '
        Me.productsDataGridTableStyle.BackColor = System.Drawing.SystemColors.Window
        ...
        Me.productsDataGridTableStyle.GridLineColor = System.Drawing.SystemColors.Control
        Me.productsDataGridTableStyle.HeaderBackColor = System.Drawing.SystemColors.Control
        ...
        Me.HeaderLbl.Font = New System.Drawing.Font("Verdana", 18.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.CloseBtn.Location = New System.Drawing.Point(256, 344)
...
#End Region
    ...
    ' 2. The 'SelectCommand' property of OleDbAdapter facilitates loading of
    '    data based on the SQL query given to access 'Products' data.
    ' 3. 'OleDbAdapter.Fill' method loads the data from data source to the DataSet.
    ...
    Private Sub ViewProductsFrm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim productsAdapter As OleDbDataAdapter = New OleDbDataAdapter()

        'Fetch Product Details
        productsAdapter.SelectCommand = New OleDbCommand("Select Product_id, product_name, " & _

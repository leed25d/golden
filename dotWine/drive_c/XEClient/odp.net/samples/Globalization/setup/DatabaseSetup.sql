...
INSERT INTO PRODUCTS  (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESC,CATEGORY,PRICE,WEIGHT)
values(1011,'Coat Broach','Broach with a beautiful large purple cut rhinestone' ,'Jewel',3343.678,155.857);

INSERT INTO PRODUCTS  (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESC,CATEGORY,PRICE,WEIGHT) 
values(1012,'Gold Necklace','Pure Gold necklace with design having touch of ancient Indian tradition' ,'Jewel',43.444,55.343);

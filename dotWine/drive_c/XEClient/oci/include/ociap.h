...
/* 
   ...
   srseshad    09/12/05 - stmtcache: callback 
      rpingte  08/19/05 - add OCIGetInstantClientPackageName
...
/*--------------------- OCIGetInstantClientPackageName ----------------------*/
sb4 OCIGetInstantClientPackageName(const oratext *comp,
                                         oratext *pkgName,
                                             ub4  nameSize,
                                             ub4  flag);
/*--------------------- End OCIGetInstantClientPackageName ------------------*/
